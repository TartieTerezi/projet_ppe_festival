...
class VueSaisieGroupe extends VueGenerique {
    ...
    public function afficher() {
        ...
        ?>
        <?php //récupération de "l'action" qui fera varier l'affichage de la page ?>
        <form method="POST" action="index.php?controleur=groupes&action=<?= $this->actionAEnvoyer ?>">
            ...
            <table width="85%" cellspacing="0" cellpadding="0" class="tabNonQuadrille">
                ...
                if ($this->actionRecue == "creer") {
                    ...
                    // sinon l'id est dans un champ caché car une modification ne peut pas changer l'ID d'un groupe
                    ?>
                    <tr>
                ...
                <tr class="ligneTabNonQuad">
                    <td> Hebergement : </td>
                    <td><input type="text" value="<?= $this->unGroupe->getHebergement() ?>" name="hebergement" 
                               size ="100" maxlength="95"></td>
