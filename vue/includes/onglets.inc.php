 ...
 * @author prof
 * @version 2017 : version initiale ; 2018 : tableau des onglets
 */
...
function getTabOnglets() : array {
    ...
    $tabOnglets[]['libelle'] = "Gestion representations"; $tabOnglets[4]['url'] = "index.php"; $tabOnglets[4]['controleur'] = "representations";
    $tabOnglets[]['libelle'] = "Offre hébergement"; $tabOnglets[5]['url'] = "index.php"; $tabOnglets[5]['controleur'] = "offres";
    $tabOnglets[]['libelle'] = "Attribution chambres"; $tabOnglets[6]['url'] = "index.php"; $tabOnglets[6]['controleur'] = "attributions";
    return $tabOnglets;
}
/**
